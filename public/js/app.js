...
function onThemeSwitcherItemClick(event) {
  var theme = event.target.dataset.theme;
  if (theme === "system") {
...
;
var themeSwitcherItems = document.querySelectorAll("#theme-switcher");
themeSwitcherItems.forEach(function (item) {
...
// import "tw-elements";
//
// initTE({ Input, Ripple, Collapse, Select });
