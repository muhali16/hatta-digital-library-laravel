...
<footer
    class="flex flex-col items-center bg-blue-900 text-center text-white">
    ...
    <div
        ...
        &copy; 2024
        <a class="text-white font-thin" href="{{url("/")}}"><span class="font-bold">Hatta</span> Digital Library.</a>
        <p>Designed and Developed By <a href="https://muhali16.vercel.app" class="font-bold text-medium hover:opacity-6">muhali16</a></p>
    </div>
</footer>
