...
@section("container")
    ...
    <main class="lg:px-24 py-28">
        ...
        <section id="result" class="px-5">
            <div class="flex flex-col gap-3 lg:items-end lg:flex-row">
                <div class="lg:w-1/3">
                    <h3>Result for</h3>
                    <h2 class="text-3xl font-bold">Category {{$category->category_name}}</h2>
                </div>
            </div>
        </section>
        ...
        <section id="result" class="py-10 px-5">
            <div class="flex flex-wrap gap-4 justify-start">
                @forelse($category->books()->get()->sortByDesc("created_at") as $book)
                    <!-- Book Card -->
                    <div
            ...
            <p class="opacity-25 text-5xl">No result category for {{$category->category_name}}</p>
            @endforelse
        </section>
    </main>
